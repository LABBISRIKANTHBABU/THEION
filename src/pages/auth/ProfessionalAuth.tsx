        ...
        <div className="min-h-screen bg-background flex flex-col md:flex-row relative">
            ...
            <div className="hidden md:flex flex-col justify-between w-1/2 bg-surface p-12 relative overflow-hidden border-r border-border/50">
                ...
                <div className="relative z-10">
                    ...
                    <div className="inline-flex items-center px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-sm font-medium mb-6">
                    ...
                    <p className="text-muted-foreground text-lg max-w-md">
                        Join a network of elite professionals and access verified opportunities that match your expertise and ambitions.
                    </p>
                </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">
                            {isLogin ? "Enter your credentials to access your account" : "Sign up to verify your professional profile"}
                        </p>
                    </div>
