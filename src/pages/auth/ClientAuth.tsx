            ...
            <div className="hidden md:flex flex-col justify-between w-1/2 bg-surface p-12 relative overflow-hidden border-r border-border/50">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-muted-foreground text-lg max-w-md">
                        Hire prescreened top talent and access world-class consulting solutions tailored for your enterprise needs.
                    </p>
                </div>

                <div className="relative z-10">
                    <blockquote className="text-muted-foreground border-l-2 border-primary/50 pl-4 py-1 italic">
                        "Access world-class talent and solutions to drive your business forward."
                    </blockquote>
                </div>
            </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">
                            {isLogin ? "Enter your credentials to access your account" : "Sign up to start hiring or consulting"}
                        </p>
                    </div>
                            ...
                            {!isLogin && (
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input id="firstName" placeholder="Business" required />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="lastName">Last name</Label>
                                        <Input id="lastName" placeholder="Name" required />
                                    </div>
                                </div>
                            )}
                            <div className="space-y-2">
